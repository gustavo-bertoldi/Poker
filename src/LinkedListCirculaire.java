...
public class LinkedListCirculaire {
    ...
    private HashMap<Joueur, Node> nodes;
    protected Node tete;
    ...
    public Joueur getJoueurHumain() throws Exception{
        return nodes.keySet().stream().filter(joueur -> joueur.humain).findFirst()
                .orElseThrow(()-> new Exception("Il n'y a pas de joueur humain dans la liste."));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        circ.getFirst().prochainNode.prochainNode.prochainNode.joueur.playing=true;

        System.out.println(circ.getNodePlaying().joueur.nom);
